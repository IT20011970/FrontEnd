...
const AdministrationMasterTab4 = (props: any) => {
  ...
  function post(){
    if ( clusterName == '' ){
      ...
      fetch('http://localhost:3000/cluster-head-controller/post',requestOptions)
      setOpenmsg(true)
      }
        ...
        >
          ...
          <DialogContent>
            <DialogContentText id="alert-dialog-description">
              Cluster Head Added Successfully !
            </DialogContentText>
          </DialogContent>
          <hr/>
          <DialogActions>
...
export default AdministrationMasterTab4;
