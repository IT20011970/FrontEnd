...
const AdministrationMasterTab5 = (props: any) => {
  ...
  function post(){
    if ( secretaryName == '' ){
      ...
      fetch('http://localhost:3000/secretary-controller/post',requestOptions)
      setOpenmsg(true)
      } 
    }
      ...
      <Box sx={{ flexGrow: 1 }}>
        <Grid container spacing={2} >
          ...
          <SelectInput
                ...
                sx={{ textAlign: 'left' }}
                //value={handledByName}
                onChange={(e) => setSecretaryName(String(e.target.value)) }
            >
...
export default AdministrationMasterTab5;
