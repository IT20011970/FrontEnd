...
import UpdateTicketModalS from "../../CreatetTicket/UpdateTicketModalS";
...
const TicketsTab2 = (props: any) => {
  ...
  async function setOpenEditModalFunction(data:any){
  ...
  return (
      <Box sx={{ flexGrow: 1 }}>
        ...
        {openEditModal === true && (
            <UpdateTicketModalS props={props} dataUpdate={dataUpdate} open={openEditModal} setOpen={setOpenEditModal}/>
        )}
      </Box>
  );
};
