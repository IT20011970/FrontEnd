...
import EditServiceCallExpences from "../EditServiceCallExpences";
...
const ExpencesTab = (props: any) => {
  ...
  return (
      <Box sx={{ flexGrow: 1 }}>
        ...
        {openEditModal === true && (
        <EditServiceCallExpences  props={props} dataUpdate={dataUpdate} openEditModal={openEditModal} setEditOpenModal={setEditOpenModal} />
        )}
      </Box>
  );
};
