...
const EditServiceCallExpences = (props: any) => {
    ...
    const [fields, setfields] = useState<any>({expire:''});
    ...
    useEffect (()=>{
        ...
        setDateCreatedOn(dataUpdate.CreatedDate);
        fields["Expense"] = dataUpdate.ExpenseType;
        fields["amount"] = dataUpdate.Amount;
        fields["createdBy"] = dataUpdate.CreatedBy;
        fields["Remarks"] = dataUpdate.Remark;
        fields["expire"] = dataUpdate.DateExpire;
        fields["expire"] = dataUpdate.DateExpire;
    ...
    function post() {
        ...
        fetch('http://localhost:3000/service-calls/Editexpences/', requestOptions)
    }
...
export default EditServiceCallExpences;
