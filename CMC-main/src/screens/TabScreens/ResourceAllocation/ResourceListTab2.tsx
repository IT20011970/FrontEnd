...
import CreateVehicleRequestModal from "../../Modals/CreateToolRequest/CreateVehicleRequestModal";
...
const ResourceListTab2 = () => {
    ...
    return (<>
                ...
                <Grid container rowSpacing={2}>
                    ...
                    <TableContainer component={Paper}>
                        <Table sx={{ minWidth: 500 }} aria-label="custom pagination table">
                            <TableHead>
                                <TableRow>
                                    <StyledTableCell>Vehicle Request ID</StyledTableCell>
                ...
                <CreateVehicleRequestModal open={openModal} setOpen={setOpenModal} />
                
            </>
    );
};

export default ResourceListTab2;
