                    ...
                    <Table aria-label="custom pagination table">
                        <TableHead>
                            <TableRow>
                                ...
                                <StyledTableCell align="right">Service Call Status</StyledTableCell>
                                <StyledTableCell align="right">Service Call Priority</StyledTableCell>
                                <StyledTableCell align="right">Customer ID</StyledTableCell>
                                <StyledTableCell align="right">Customer Name</StyledTableCell>
                                <StyledTableCell align="right">Service Call Location</StyledTableCell>
                                <StyledTableCell align="right">Contact Person</StyledTableCell>
                                <StyledTableCell align="right">Contact NO</StyledTableCell>
                                <StyledTableCell align="right">Origine</StyledTableCell>
                                <StyledTableCell align="right">Problem Type</StyledTableCell>
                                <StyledTableCell align="right">Inquiry Type</StyledTableCell>
                                <StyledTableCell align="right">Subject</StyledTableCell>
                                <StyledTableCell align="right">Created By</StyledTableCell>
                                <StyledTableCell align="right">Handled By</StyledTableCell>
                                <StyledTableCell align="right">Queue</StyledTableCell>
                                <StyledTableCell align="right">Secretary</StyledTableCell>
                                <StyledTableCell align="right">Sales Assistant</StyledTableCell>
                                <StyledTableCell>Planned Start Date</StyledTableCell>
                                <StyledTableCell>Planned End Date</StyledTableCell>
                        ...
                        <TableBody>
                            {(rowsPerPage > 0
                                ...
                                <StyledTableRow key={row.ServiceCallId}>
                                    ...
                                    <StyledTableCell>
                                        {row.customerEntity.TelephoneNo}
                                    </StyledTableCell>
                                    <StyledTableCell>
                                        {row.Origin}
                                    </StyledTableCell>
