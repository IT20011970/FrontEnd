...
import AttendanceModel from "../../Modals/Attendance/AttendanceModel";
import { MenuItem, Select, TextField } from "@material-ui/core";
import { LocalizationProvider, DateTimePicker, DatePicker } from "@mui/lab";
        ...
        <>
            <Stack spacing={6} direction="row">
                <Grid container rowSpacing={1}>
                    <Grid item xs={6}>
                        <Heading> View Attendance</Heading>
            ...
            <AttendanceModel open={openModal} setOpen={setOpenModal} />
        </>
    );
};

export default AttendanceTab1;
