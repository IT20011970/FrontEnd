...
const AdministrationMasterSubTab7 = () => {
    ...
    const getData = async() => {
        ...
        fetch('http://localhost:3000/engineer-controller/get',requestOptions)
    ...
    const deleteData = async(id: any) => {
        ...
        if(window.confirm("Are you sure you want to Delete this Engineer?")){
            ...
            await fetch(`http://localhost:3000/engineer-controller/delete/${id}`,requestOptions)
                .then(response=>{ return response.json()})
                .then(data=>{
                    getData();
                });
...
export default AdministrationMasterSubTab7;
