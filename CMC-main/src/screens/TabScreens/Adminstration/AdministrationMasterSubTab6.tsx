...
const AdministrationMasterSubTab6 = () => {
    ...
    const deleteData = async(id: any) => {
        ...
        if(window.confirm("Are you sure you want to Delete this Sales Assistant?")){
            ...
            await fetch(`http://localhost:3000/sales-assistant-controller/delete/${id}`,requestOptions)
                .then(response=>{ return response.json()})
                .then(data=>{
                    getData();
                });
        ...
        <>
            ...
            <Container>
                <TableContainer component={Paper}>
                    <Table sx={{ minWidth: 500 }} aria-label="custom pagination table">
                        <TableHead>
                            <TableRow >
                                <StyledTableCell sx={{ align: 'center' }}>Sales Assistants</StyledTableCell>
                        ...
                        <TableBody>
                            {(rowsPerPage > 0
                                    ...
                                    : rows
                            ).map((row: SalesAssistant, i: number) => (
                                <StyledTableRow key={row.SalesAssistantCode}>
                                    {/* <StyledTableCell
                                        sx={{
                                            borderLeft: "none",
                                            textAlign: "center"
                                    ...
                                    <StyledTableCell>
                                        ...
                                        <ControlButton disableRipple onClick={() => deleteData(row.SalesAssistantCode)}>
            ...
            <Dialog
                ...
                <DialogContent>
                    ...
                    Sales Assistant Removed Successfully !
                    </DialogContentText>
                </DialogContent>
                <hr/>
                <DialogActions>
...
export default AdministrationMasterSubTab6;
