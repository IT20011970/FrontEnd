...
const AdministrationMasterSubTab3 = () => {
    ...
    const deleteData = async(id: any) => {
        ...
        if(window.confirm("Are you sure you want to Delete this Handled By Person?")){
            ...
            await fetch(`http://localhost:3000/handled-by-controller/delete/${id}`,requestOptions)
                .then(response=>{ return response.json()})
                .then(data=>{
                    getData();
                });
        ...
        <>
            ...
            <Container>
                <TableContainer component={Paper}>
                    <Table sx={{ minWidth: 500 }} aria-label="custom pagination table">
                        <TableHead>
                            <TableRow >
                                <StyledTableCell sx={{ align: 'center' }}>Handled By Persons</StyledTableCell>
                        ...
                        <TableBody>
                            {(rowsPerPage > 0
                                    ...
                                    : rows
                            ).map((row: HandledBy, i: number) => (
                                <StyledTableRow key={row.HandledByCode}>
                                    {/* <StyledTableCell
                                        sx={{
                                            borderLeft: "none",
                                            textAlign: "center"
            ...
            <Dialog
                ...
                <DialogContent>
                    ...
                    Handled By Person Removed Successfully !
                    </DialogContentText>
                </DialogContent>
                <hr/>
                <DialogActions>
...
export default AdministrationMasterSubTab3;
