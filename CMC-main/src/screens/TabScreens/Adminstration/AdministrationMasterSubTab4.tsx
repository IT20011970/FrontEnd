...
const AdministrationMasterSubTab4 = () => {
    ...
    const deleteData = async(id: any) => {
        ...
        if(window.confirm("Are you sure you want to Delete this Cluster Head?")){
            ...
            await fetch(`http://localhost:3000/cluster-head-controller/delete/${id}`,requestOptions)
                .then(response=>{ return response.json()})
                .then(data=>{
                    getData();
                });
            ...
            <Container>
                <TableContainer component={Paper}>
                    <Table sx={{ minWidth: 500 }} aria-label="custom pagination table">
                        <TableHead>
                            <TableRow >
                                <StyledTableCell sx={{ align: 'center' }}>Cluster Heads</StyledTableCell>
                        ...
                        <TableBody>
                            {(rowsPerPage > 0
                                    ...
                                    : rows
                            ).map((row: ClusterHead, i: number) => (
                                <StyledTableRow key={row.ClusterHeadCode}>
                                    {/* <StyledTableCell
                                        sx={{
                                            borderLeft: "none",
                                            textAlign: "center"
                                    ...
                                    <ControlButton disableRipple onClick={() => deleteData(row.ClusterHeadCode)}>
            ...
            <Dialog
                ...
                <DialogContent>
                    <DialogContentText id="alert-dialog-description">
                            Cluster Head Removed Successfully !
                    </DialogContentText>
                </DialogContent>
                <hr/>
                <DialogActions>
...
export default AdministrationMasterSubTab4;
